      ...
      <ThemedView style={styles.container}>
        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="File-based routing">
            ...
            <ThemedText type="small">
              O arquivo do layout é o o arquivo <ThemedText type="code">src/app/_layout.tsx</ThemedText> permite configurar a aba de navegação
            </ThemedText>
          ...
          <Collapsible title="Android, iOS, and web support">
            <ThemedView type="backgroundElement" style={styles.collapsibleContent}>
              <ThemedText type="small">
                Você pode abrir seu projeto no Android, iOS, e na web. Para abrir na versão web, clique no teclado, a tecla <ThemedText type="smallBold">w</ThemedText> no terminal onde seu projeto está sendo executado.
              </ThemedText>
              <Image
          ...
          <Collapsible title="Images">
            <ThemedText type="small">
              ...
              <ThemedText type="code">@3x</ThemedText> para disponibilizar para diferentes resoluções de telas.
            </ThemedText>
          ...
          <Collapsible title="Animations">
            <ThemedText type="small">
              Este template inclui um componente de animação. O{' '}
